...
require (
	...
	github.com/sourcenetwork/lens/tests/action v0.0.0
	github.com/sourcenetwork/lens/tests/modules v0.0.0
	github.com/sourcenetwork/lens/tests/multiplier v0.0.0
...
require (
	...
	github.com/sourcenetwork/go-p2p v0.1.2 // indirect
...
replace (
	github.com/sourcenetwork/lens/host-go v0.0.0 => ../../host-go
	github.com/sourcenetwork/lens/tests/action v0.0.0 => ../action
	github.com/sourcenetwork/lens/tests/modules v0.0.0 => ../../tests/modules
	github.com/sourcenetwork/lens/tests/multiplier v0.0.0 => ../multiplier
	github.com/sourcenetwork/lens/tests/state v0.0.0 => ../state
)
